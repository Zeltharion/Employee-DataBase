...
{
    /// <summary>
    /// Связывание View части и Model - Биндинги
    /// </summary>
    public class DataManageVM : INotifyPropertyChanged
    {
        ...
        public RelayCommand DeleteItem => deleteItem ?? new RelayCommand(obj =>
                                                       {
